...
/**
 * A classe ParameterUseCases é responsável por carregar e manipular parâmetros a partir de um arquivo de texto.
 */
public class ParameterUseCases{
    ...
    /**
     * Carrega os parâmetros a partir de um arquivo de texto.
